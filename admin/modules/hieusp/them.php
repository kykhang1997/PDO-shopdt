<div class="container">
    <div class="row">
        <div class="col-sm-10 border-right" >
            <form action="modules/hieusp/xuly.php" method="post" enctype="multipart/form-data">
                <h3>&nbsp;</h3>
                <table width="100%" >
                    ...
                    <tr>
                        ...
                        <td width="87"><input type="text" name="tenhieu"></td>
                    </tr>
                    <tr>
                        <td>Tình Trạng</td>
        ...
        <div class="col-sm-2">
        <h3>&nbsp;</h3>
            <a href="index.php?quanly=hieusp&ac=lietke" class="btn btn-outline-danger">Liệt Kê Loại Sản Phẩm</a>
        </div>
    </div>
</div>